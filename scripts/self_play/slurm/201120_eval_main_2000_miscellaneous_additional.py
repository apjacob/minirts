...
JOB_SWEEP_NAME = "201120_eval_main_2000_miscellaneous_additional"
...
for exp_code in experiments:
    ...
    python_command = (
        "python -u /home/gridsan/apjacob/minirts/scripts/self_play/multitask_pop_eval_2.py "
        "--seed=777 --num_games=2000 --num_trials=1 "
        ...
        "--model_json=/home/gridsan/apjacob/save/wandb_models_2020-11-20 "
