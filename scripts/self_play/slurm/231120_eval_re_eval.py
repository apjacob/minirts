...
JOB_SWEEP_NAME = "231120_eval_re_eval.py"
...
for exp_code in experiments:
    ...
    python_command = (
        "python -u /home/gridsan/apjacob/minirts/scripts/self_play/multitask_pop_eval_3.py "
        ...
        "--model_json=/home/gridsan/apjacob/save/wandb_models_2020-11-23 "
