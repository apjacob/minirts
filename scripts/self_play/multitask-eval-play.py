...
model_dicts = {
    ...
    "pop_finetuned_rule80": {
        ...
        "best_coach": "best_coach_checkpoint_80_841.pt",
    },
    "pop_finetuned_rule3": {
        "rule": 3,
        "model": "lunar-fog-7",
        ...
        "best_coach": "best_coach_checkpoint_3_1561.pt",
    },
    "pop_finetuned_rule13": {
        "rule": 13,
        "model": "lunar-fog-7",
        "run_path": "apjacob/adapt-minirts-pop/1ygw8r46",
        "best_exec": "best_exec_checkpoint_13_1443.pt",
        "best_coach": "best_coach_checkpoint_13_1443.pt",
    },
    "pop_finetuned_rule12": {
        "rule": 12,
        "model": "lunar-fog-7",
        "run_path": "apjacob/adapt-minirts-pop/1ygw8r46",
        "best_exec": "best_exec_checkpoint_12_1262.pt",
        "best_coach": "best_coach_checkpoint_12_1262.pt",
    },
    "both_finetuned_rule12": {
        "rule": 12,
...
def self_play(args):
    ...
    wandb.run.name = (
        f"multitask-fixed_int-{wandb.run.id}-{args.coach1}-{args.executor1}"
    ...
    log_name = "multitask-fixed-analyze_c1_type={}_c2_type={}__e1_type={}_e2_type={}__lr={}__num_sp={}__num_rb={}_{}_{}".format(
        _coach1,
        args.coach2,
        _executor1,
        args.executor2,
    ...
    for rule_idx in rules:
        ...
        game.analyze_rule_games(
            cur_iter_idx, rules, "train", viz=args.viz, num_games=args.num_games
        )
        game.terminate()
        del game
